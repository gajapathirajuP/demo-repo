  # Set 
        ...
        # Sets are UUU 
            ...
            # U - Unique Data Ony  (No Duplicates)

            # U - Unindex 

            # U - Unordered  

    # Sets are specifically used with math sets operations 

    # Sets support different methods for performing operations on data 
    ...
    # Frozen Set 
        ...
        # NOTE : Frozen Set are Immutable Unlike Sets 

        # Frozen Sets cannot be represented using symbols, only with class we can create 

        # NOTE : Frozen Set only supports math related set operations 
