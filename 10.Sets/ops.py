  # Sets Operations 
    ...
    # frozen set operations are exactly same as set, except they are immutable 

    # Set Characteristics 

        # Order : Sets are UnOrdered (insertion order is not preserved)

        # Mutable : Sets are Mutable (can be changed)

        # Duplicates : Sets Doesn't Allow Duplicates 
    
    # Frozen Set Characteristics 

        # Order : Sets are UnOrdered (insertion order is not preserved)

        # Immutable : Frozen Sets are Immutable (cannot be changed)

        # Duplicates : Frozen Sets Doesn't Allow Duplicates

    
    # How to use above data structures in Applications ?
    ...
    # CRUD Applications (Database - Web Applications)    
