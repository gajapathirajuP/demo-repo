  # Dictionaries 
        ...
        # Dictionaries is a data structure which allows you to store multiple key & values in a single variable, each item is separated with , 
        ...
        # Accessing Data In Dictionaries 
            ...
            # Like in Strings, we don't have index concept in Dictionaries

                # NOTE: Dictionaries don't have INDEX 

            # Doesn't Support Positive & Negative Index 
        ...
        # Duplicates allowed in Dictionaries with conditions 

            # Values can be Duplicated 
            # Keys should be Unique  

            # Keys should be immutable objects only 
                # 90% and above strings will be keys 
    ...
    # Dictionaries support different methods for performing operations on data 
